        ...
        for user in pending:
            ...
            if not is_vip and last_used:
                ...
                if elapsed < timedelta(hours=24):
                    ...
                    result = f"❌ *Daily Limit Reached purchase vip contact @dg_gaming_1m no verifiy*\n\n⏳ Try again after: {hours}h {minutes}m"
            ...
            try:
                ...
                if added == 0:
                    result = "💔 UID {uid} ({player_name}) has already received max likes for today 😢. Try again tomorrow!"
                else:
                    result = (
